/**
 * CLI-specific utilities for DOCX export scripts (export-docx.js, docx-diff.js).
 *
...
/**
 * Loads front page data from a JSON file and builds the DOCX front page.
 *
 ...
 * @returns {object|null} Front page DOCX object, or null on failure.
 */
function loadFrontPage(frontPageDataFile, opts = {}) {
  ...
  try {
    ...
    return buildFrontPageDocx(data)
  } catch (e) {
    if (strict) {
