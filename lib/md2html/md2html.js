...
class Md2Html {
   ...
   */
  renderBody(content, forPreview, baseDir = null, filePath = null, specRootPath = null, includeFrontPage = false) {
    ...
    if (includeFrontPage && this.frontPageHtml) {
...
${extraHeadContent}
   ...
   */
  renderMarkdown(content, baseDir = null, filePath = null, specRootPath = null, includeFrontPage = false) {
    const htmlBody = this.renderBody(content, true, baseDir, filePath, specRootPath, includeFrontPage)
   ...
   * @returns {string} Complete HTML document string.
   */
  renderMarkdownForExport(content, specRootPath = null, includeFrontPage = false) {
    const htmlBody = this.renderBody(content, false, null, null, specRootPath, includeFrontPage)
