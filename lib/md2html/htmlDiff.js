...
function diffHtml(opts) {
  ...
  const baselineBody = handler.renderBody(
    baselineContent, false, null, null, null, frontPageData, crCoverPageData, true, baselineAbsResolver, true
  )
  const renderedCurrentBody = handler.renderBody(
    currentContent, false, null, null, null, frontPageData, crCoverPageData, true, currentAbsResolver, true
  )
