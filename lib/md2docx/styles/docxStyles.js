...
function paragraphStyles() {
  return [
    ...
    },
    {
      ...
      paragraph: { alignment: AlignmentType.LEFT, indent: { left: 1134, hanging: 1134 }, spacing: { before: 240, after: 180 }, keepNext: true, keepLines: true, border: { top: { style: BorderStyle.SINGLE, size: 12, color: 'auto' } } }
    },
    {
