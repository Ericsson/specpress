  ...
  return [
    {
      ...
      paragraph: { alignment: AlignmentType.JUSTIFIED, spacing: { before: 180, after: 180, line: 240, lineRule: 'auto' } }
    },
    {
      id: 'Heading1', name: 'Heading 1', basedOn: 'Normal',
      run: { font: 'Arial', size: 36 },
      paragraph: { alignment: AlignmentType.LEFT, indent: { left: 1134, hanging: 1134 }, spacing: { before: 480, after: 180 }, keepNext: true, keepLines: true, border: { top: { style: BorderStyle.SINGLE, size: 12, color: 'auto' } } }  // pageBreakBefore: true
    },
    {
      id: 'Heading2', name: 'Heading 2', basedOn: 'Heading1',
      run: { font: 'Arial', size: 32 },
      paragraph: { indent: { left: 1134, hanging: 1134 }, spacing: { before: 180, after: 180 }, keepNext: true }
    },
    {
      id: 'Heading3', name: 'Heading 3', basedOn: 'Heading2',
      run: { font: 'Arial', size: 28 },
      paragraph: { indent: { left: 1134, hanging: 1134 }, spacing: { before: 180, after: 120 }, keepNext: true }
    },
    {
      id: 'Heading4', name: 'Heading 4', basedOn: 'Heading3',
      run: { font: 'Arial', size: 24 },
      paragraph: { indent: { left: 1418, hanging: 1418 }, spacing: { before: 150, after: 120 }, keepNext: true }
    },
    {
      id: 'Heading5', name: 'Heading 5', basedOn: 'Heading4',
      run: { font: 'Arial', size: 22 },
      paragraph: { indent: { left: 1701, hanging: 1701 }, spacing: { before: 120, after: 100 }, keepNext: true }
    },
    {
    ...
    {
      id: 'Heading9', name: 'Heading 9', basedOn: 'Heading8',
      run: { font: 'Arial', size: 36 },
      paragraph: { alignment: AlignmentType.LEFT, spacing: { before: 240, after: 180 }, keepNext: true }
    },
    {
      id: 'TH', name: 'TH', basedOn: 'Normal',
      run: { bold: true, font: 'Arial' },
      paragraph: { alignment: AlignmentType.CENTER, spacing: { before: 60 }, keepNext: true, keepLines: true }
    },
    {
    ...
    {
      id: 'EQ', name: 'EQ', basedOn: 'Normal',
      paragraph: { alignment: AlignmentType.LEFT, spacing: { before: 120, after: 120 }, tabStops: [{ type: TabStopType.CENTER, position: 4536 }, { type: TabStopType.RIGHT, position: 9072 }], keepLines: true }
    },
    {
      id: 'EX', name: 'EX', basedOn: 'Normal',
      paragraph: { indent: { left: 1300, hanging: 1300 }, keepLines: true }  // , tabStops: [{ type: TabStopType.LEFT, position: 1300 }]
    },
    {
      id: 'TAL', name: 'TAL', basedOn: 'Normal',
      run: { font: 'Arial', size: 18 },
      paragraph: { alignment: AlignmentType.LEFT, indent: { left: 60, right: 60 }, spacing: { before: 60, after: 60, lineRule: 'auto' }, keepLines: true, keepNext: true}
    },
    {
    ...
    },
    {
      ...
      paragraph: { alignment: AlignmentType.LEFT, spacing: { before: 0, after: 0, line: 240, lineRule: 'auto' }, shading: { fill: '303030' } }
    },
    {
      id: 'FP', name: 'FP', basedOn: 'Normal',
      paragraph: { alignment: AlignmentType.LEFT, spacing: { before: 0, after: 0, line: 240, lineRule: 'auto' } }
    },
    {
      id: 'Header', name: 'Header', basedOn: 'Normal',
      run: { font: 'Arial', size: 18, bold: true },
      paragraph: { alignment: AlignmentType.LEFT, spacing: { before: 0, after: 0 } }
    },
    {
      id: 'CRCoverPage', name: 'CR Cover Page', basedOn: 'Normal',
      run: { font: 'Arial', size: 20 },
      paragraph: { alignment: AlignmentType.LEFT, spacing: { before: 0, after: 0 } }
    },
    {
      id: 'CRCoverNarrow', name: 'CR Cover Narrow', basedOn: 'Normal',
      run: { font: 'Arial', size: 8 },
      paragraph: { spacing: { before: 0, after: 0, line: 120, lineRule: 'exact' } }
    },
    {
      id: 'CRSeparator', name: 'CR_Separator', basedOn: 'Normal',
      run: { font: 'Times New Roman', size: 36, color: '0000FF' },
      paragraph: { alignment: AlignmentType.CENTER, spacing: { before: 0, after: 180 } }
    },
    {
    ...
    },
    {
      ...
      paragraph: { alignment: AlignmentType.RIGHT, spacing: { before: 0, after: 0 } }
    },
    {
      id: 'ZT', name: 'ZT', basedOn: 'Normal',
      run: { font: 'Arial', size: 34, bold: true },
      paragraph: { alignment: AlignmentType.RIGHT, spacing: { before: 0, after: 0, line: 240, lineRule: 'atLeast' } }
    },
    ...
    ...Array.from({ length: 9 }, (_, i) => ({
      id: `TOC${i + 1}`, name: `TOC ${i + 1}`, basedOn: i === 0 ? 'Normal' : `TOC${i}`,
      paragraph: {
        run: { font: 'Times New Roman', size: i === 0 ? 22 : 20 },
        indent: { left: 567 + (i * 284), hanging: 567 + (i * 284) },
        spacing: { after: 0, before: i === 0 ? 120 : 0 },
        tabStops: [{ type: TabStopType.RIGHT, position: TabStopPosition.MAX, leader: 'dot' }], keepLines: true, keepNext: true
      }
    }))
  ]
}
