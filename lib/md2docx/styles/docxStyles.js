...
function paragraphStyles() {
  return [
    ...
    },
    {
      ...
      paragraph: { alignment: AlignmentType.LEFT, indent: { left: 1200, hanging: 1200 }, spacing: { before: 240, after: 180 }, keepNext: true, keepLines: true }  // pageBreakBefore: true
    },
    {
      id: 'Heading2', name: 'Heading 2', basedOn: 'Heading1',
      run: { font: 'Arial', size: 32 },
      paragraph: { indent: { left: 1200, hanging: 1200 }, spacing: { before: 180, after: 180 }, keepNext: true }
    },
    {
    ...
    },
    {
      ...
      paragraph: { indent: { left: 1300, hanging: 1300 }, tabStops: [{ type: TabStopType.LEFT, position: 1300 }], keepLines: true }
    },
    {
    ...
    },
    {
      ...
      paragraph: { alignment: AlignmentType.LEFT, spacing: { after: 0, line: 240, lineRule: 'auto' }, shading: { fill: '222222' } }
    },
    {
    ...
    },
    {
      ...
      paragraph: { alignment: AlignmentType.RIGHT, spacing: { after: 0, line: 240, lineRule: 'atLeast' } }
    },
