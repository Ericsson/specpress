...
/**
 * Builds front page sections for a 3GPP specification DOCX document.
 *
 * Returns an object with section configurations to prepend before the spec content.
 ...
 * @param {string} [assetsDir=TEMPLATES_DIR] - Directory containing logo images (5gAdvancedLogo.jpg, 3gppLogo.png).
 * @returns {Object} Section configuration objects (frontSection, innerSection, bodyHeaderFooter).
 */
function buildFrontPageDocx(data, assetsDir = TEMPLATES_DIR) {
...
module.exports = { buildFrontPageDocx }
