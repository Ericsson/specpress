...
async function convertToDocx(opts) {
  ...
  const converter = new MarkdownToDocxConverter(opts.mermaidConfig, opts.specRoot, null, null, converterOptions)
  ...
  await converter.convert(tempMd, docxPath, baseDir, frontPageData, {
