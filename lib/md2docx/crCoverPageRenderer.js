    ...
    rows: [
      ...
      new TableRow({
        children: [
          ...
          crCell(7, null, crP({ text: 'CR', bold: true, size: 28 }, AlignmentType.CENTER)),
          crCell(13, YELLOW, crP({ text: formatCRNumber(crData.CR), bold: true, size: 28 })),
          crCell(7, null, crP({ text: 'rev', bold: true, size: 28 }, AlignmentType.CENTER)),
          crCell(11, YELLOW, crP({ text: formatRevNumber(crData.rev), bold: true, size: 28 }, AlignmentType.CENTER)),
          crCell(25, null, crP({ text: 'Current version:', bold: true, size: 28 }, AlignmentType.CENTER)),
    ...
    rows: [
      ...
      new TableRow({
        children: [
          ...
          crCell(22, YELLOW, crP({ text: crData.Release || extractRelease(crData['Current version']) }))
        ]
      }),
