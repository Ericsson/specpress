...
/**
 * Concatenates specification files into a single buffer
 * @param {string} folderPath - Path to folder containing specification files
 * @returns {Promise<Buffer>} Concatenated file contents with code blocks
 * @throws {Error} If folder cannot be read
 * @example
 * const buffer = await concatenateFiles('./src/spec');
 */
